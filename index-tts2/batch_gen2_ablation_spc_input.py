...
def get_emotion_vector(emotion: str) -> tuple[list[float], str]:
    ...
    if emotion in EMOTION_DIMENSIONS:
        ...
        # Fallback to calm
        vec[EMOTION_DIMENSIONS.index("calm")] = 1.4
        emotion = "calm"
    return vec, emotion
    ...
    for sent_idx, item in enumerate(data):
        ...
        try:
            ...
            for seg in segments:
                ...
                prompt_wav_path = prompt_getter(speaker_id, emotion)
            ...
            spk_prompt = [str(prompt_path) for prompt_path in prompt_paths]
