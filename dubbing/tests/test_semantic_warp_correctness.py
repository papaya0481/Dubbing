...
REAL_DATA_DIR = Path("/data2/ruixin/datasets/MELD_gen_pairs/sent_emo/aligned")
...
# =============================================================================
# 真实数据验证：从 MELD_gen_pairs 中采样
# =============================================================================

REAL_DATA_AVAILABLE = REAL_DATA_DIR.exists()
...
def test_real_data_word_equal():
    ...
    for fname in files:
        ...
        if not p2.exists():
            continue
        r1 = tgt.io.read_textgrid(str(REAL_DATA_DIR / fname))
        r2 = tgt.io.read_textgrid(str(p2))
